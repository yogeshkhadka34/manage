    ...
    <>
      <section id="hero" className="relative overflow-hidden ">
        ...
        <div className="container flex flex-col-reverse items-center justify-center  px-6 mx-auto mt-6 space-y-0 md:mt-10 md:flex-row md:mb-10 lg:mb-40">
          {/* Left Item */}
          <div className="flex flex-col justify-center mb-10 space-y-12 md:space-y-12 md:w-1/2">
            <h1 className="max-w-md text-4xl font-bold text-center md:text-4xl md:text-left md:mt-24 md:pr-3 xl:mt-32 xl:max-w-[unset]">
